...
#[no_mangle]
pub extern "C" fn ristretto255_derive_secret_key(sk: ristretto255::SecretKey, id: ristretto255::Random, r: ristretto255::Random) -> ristretto255::Keypair {
    ristretto255::derive_secret_key(sk, id, r)
}

#[no_mangle]
pub extern "C" fn ristretto255_derive_public_key(pk: ristretto255::PublicKey, id: ristretto255::Random, r: ristretto255::Random) -> ristretto255::Keypair {
